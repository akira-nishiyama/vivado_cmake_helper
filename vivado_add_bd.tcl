...
#
# Arguments:
#       $argv  0:blockdesign add script written by vivado export_bd command.
#
# Usage:
#    vivado -mode batch -source ../scripts/vivado_add_bd.tcl -tclargs ../scripts/sim_ics_if.tcl
#
set add_bd_tcl   [lindex $argv  0]
